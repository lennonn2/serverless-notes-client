  ...
  handleSubmit = async (event) => {
    ...
    try {
      ...
      if (this.file) {
        ...
        await s3Delete(this.state.note.attachment.key, this.props.userToken);
      }
        ...
        { this.state.note &&
          ( <form onSubmit={this.handleSubmit}>
              ...
              ( <FormGroup>
                ...
                <FormControl.Static>
                  <a target="_blank" href={ this.state.note.attachment.location }>
                    { this.formatFilename(this.state.note.attachment.location) }
                  </a>
                </FormControl.Static>
              </FormGroup> )}
